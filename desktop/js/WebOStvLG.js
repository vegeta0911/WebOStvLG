...
if(version_WebOStvLG != '4' && conf_mode_WebOStvLG!='standalone'){
    ...
    $.ajax({
      ...
      success: function (data) {
          if (data.state != 'ok') {
              $('#div_alert').showAlert({message: 'Erreur message WebOStvLG', level: 'danger'});
              return;
          }
      }
    })
